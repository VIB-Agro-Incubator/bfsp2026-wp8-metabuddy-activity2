...
This repo contains the API specifications as defined in activity 2 of the BFSP WP8 MetaBuddy program. It documents how the ISA Wizard can access the functionalities developed for the MetaBuddy.
