...
This repo contains the API specifications as defined in activity 2 of the ELIXIR BFSP 2026 WP8 MetaBuddy program. It documents how the ISA Wizard can access the AI enrichment functionalities developed for the MetaBuddy.
